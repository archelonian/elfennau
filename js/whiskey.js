...
//                     Co So Sy Vo SG CG Cn St La DR Na Lb Rd Co An Di Do Hi L1 Fr Ba Tn Ph AT
                ["000", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 2, 0, 2, 0, 2, 2, 2],// i
                ["001", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 2, 0, 2, 0, 2, 2, 2],// y
                ["020", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 2, 0, 0, 0, 2, 2, 0],//  
                ["021", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 2, 0, 0, 0, 2, 2, 0],//  
                ["040", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 2, 0, 0, 2, 2, 2, 0],// w
                ["041", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 2, 0, 0, 2, 2, 2, 2],// u
                ["110", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 2, 0, 2, 0, 0, 2, 0],// i
                ["111", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 2, 0, 2, 0, 0, 2, 0],// y
                ["131", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 2, 0, 0, 2, 0, 2, 0],// u
                ["200", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 0, 2, 0, 2, 2, 2],// e
                ["201", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 0, 0, 2, 0, 2, 2, 2],// oe
                ["220", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 0, 0, 0, 2, 2, 0],//  
                ["221", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 0, 0, 0, 0, 2, 2, 0],//  
                ["240", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 0, 0, 2, 2, 2, 2],// v
                ["241", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 0, 0, 0, 2, 2, 2, 2],// o
                ["320", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 0, 0, 0, 0, 2, 0],// @
                ["400", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 0, 2, 0, 0, 2, 0],// E
                ["401", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 0, 0, 2, 0, 0, 2, 0],// oe
                ["420", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 0, 0, 0, 0, 2, 0],//  
                ["421", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 0, 0, 0, 0, 0, 2, 0],//  
                ["440", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 0, 0, 2, 0, 2, 0],// ^
                ["441", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 0, 0, 0, 2, 0, 2, 0],//  
                ["510", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 2, 2, 0, 2, 2, 0],// ae
                ["520", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 2, 0, 0, 2, 2, 0],//  
                ["620", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 2, 0, 0, 0, 2, 0],// a
                ["621", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 0, 2, 0, 0, 0, 2, 0],// OE
                ["640", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 0, 0, 1, 1, 2, 0, 2, 0, 2, 0, 2, 0],//  
                ["641", 0, 2, 2, 2, 0, 0, 2, 0, 0, 0, 0, 2, 2, 0, 1, 1, 2, 0, 2, 0, 2, 0, 2, 0] //  
               ];
